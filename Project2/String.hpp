/**
 * Utilized by Nassim Marhari
 * string.hpp - milestone 2 ver
...
#include <iostream>
#include <vector> 		//for milestone 3
...
public:
    ...
    std::vector<String> split(char) const;                 //milestone 3
    int     convertInt()                        const;  // convert String to int
...
bool	operator==	(const String&, const char[]);	// added variation
bool    operator==      (char, const String&);
bool	operator==	(const String&, char);		// added variation
bool    operator<       (const char[], const String&);
bool	operator<	(const String&, const char[]);	// added variation
bool    operator<       (char, const String&);
bool	operator<	(const String&, char);		// added variation
